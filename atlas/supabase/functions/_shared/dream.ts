export type DreamInterpretationDto = {
  entryId: string;
  chinese: string;
  jungian: string;
  reflection: string;
...
export function aggregateDreamTrend(
  entries: Array<{ symbols?: string[] | null; emotions?: string[] | null; created_at?: string }>,
  periodDays = 7
): { periodDays: number; topSymbols: Array<{ symbol: string; count: number }>; summary: string } {
