# 历史文本素材需求基线 · TEXT REQUIREMENTS BASELINE

> **归档标识（2026-07-31）**：本文是旧版 T1–T6 文本库存与密度任务记录，已由当前版 [`../TEXT_REQUIREMENTS.md`](../TEXT_REQUIREMENTS.md) 替代。文中的数量、完成状态和“可选续作”判断只代表归档时的历史基线，不作为当前实现依据。

**2026-07-31 · Godot v3.0。** 汇总**已交付文本资产**与**仍待写的密度任务**。执行步骤见 `[PLAN.md](../PLAN.md)`；T3/T4/T6 规格见 `[STORY_REQUIREMENTS_2026-07-26_T3-T6.md](STORY_REQUIREMENTS_2026-07-26_T3-T6.md)`；中译流程见 `[L10N_PLAN.md](../L10N_PLAN.md)`。
...
| ------------------------ | --------------------------- |
| **本文**                   | 文本/语料**需求与完成度**             |
| `STORY_REQUIREMENTS_2026-07-26_T3-T6.md` | T3/T4/T6 **操作规格** + G26/G27 |
