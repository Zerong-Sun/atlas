...
| P5 | 入城加长五城；12 主城入口后果链 | ✅；城市内 site/mentor 多轮互动仍待生产 |
...
| 12 主城 site/mentor 多轮文本 | 入口链已闭环；36 site + 12 mentor 中仅 1 个 site 有第二页 | `TEXT_REQUIREMENTS.md` §4–§10；逐对象矩阵和 smoke |
| 102 城分支深化 | 12 主城先补城市内互动，其余事件保持可运行 | 需求书 §4.7、§10；后续按城市批次人工通读 |

---

## 8. 建议的下一步

1. **12 主城城市内多轮文本**：补 35 个 site 和 12 个 mentor 的第二页及分支矩阵
2. **正式课程文本**：占位迁移 i18n，并完成中英与文化校读
3. **优化与发布验证**：导入/导出、存档 P95、地图帧耗、720p/200%/中英回归
4. **正式占法美术与既有缺图**：易经 31–64（34）及 §11.7 占位替换
