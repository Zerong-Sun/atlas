...
**门禁 24 道全绿**（advisory WARN 均为既有已知项），16 个内核单测与 12 个界面 smoke
全绿。
...
```
en 2501 条 · zh 2501 条 · 缺 0 · 中英同文 0
译文时效 1334 current · 0 stale · 0 missing
```
...
| 102 城分支深化 | 现有事件可运行 | 需求书 §4.7、§10；全分支人工通读 |
...
4. **既有缺图**：`scene-region-chr` → 白图泰 6+18
