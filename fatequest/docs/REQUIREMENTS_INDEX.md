...
- 102 城、204 路线、332 事件、60 商品、54 随从、24 种占法注册；12 主城已接入 24 条重要选择后果链和 12 个导师事件，大不里士外国商人已接入独立后续事件。
- 事件选择共 782 项，50 项队列接线，285 项即时反馈；首批主城无反馈选择 0。
- 运行时美术 674 张，`art_wire_index.json` 为 674/674，未接线 0。
- en/zh 各 3179 条，缺失 0；故事单元 109 个；译文 stamps 1838 current、0 stale。
