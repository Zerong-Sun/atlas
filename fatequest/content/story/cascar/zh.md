...
stamps:
  ...
  ev.ev_cascar_a_followup.choice_1_result: 61432e50735e
  ev.ev_cascar_a_followup.choice_2: a49a6e2f0662
  ev.ev_cascar_a_followup.choice_2_result: e93cd3b18db8
  ev.ev_cascar_a_followup.choice_3: 2b207b5e3f6d
  ev.ev_cascar_a_followup.choice_3_result: adf4ae5cfdb0
  ev.ev_cascar_b_followup.title: fbc486b8f2f4
  ev.ev_cascar_b_followup.body: f4acabee37a3
  ev.ev_cascar_b_followup.choice_1: 492ca25e61d7
  ev.ev_cascar_b_followup.choice_1_result: fcc9ec678ab4
  ev.ev_cascar_b_followup.choice_2: c182f87bc167
  ev.ev_cascar_b_followup.choice_2_result: 94ba85011b44
  ev.ev_cascar_b_followup.choice_3: d4cd2c5f8a80
  ev.ev_cascar_b_followup.choice_3_result: 16f45f8bdec2
  ev.ev_cascar_c_followup.title: 32bba521161d
  ev.ev_cascar_c_followup.body: 7d786087da10
  ev.ev_cascar_c_followup.choice_1: 16be27e769b5
  ev.ev_cascar_c_followup.choice_1_result: e8b79de6f710
  ev.ev_cascar_c_followup.choice_2: 9a1a5d841b89
  ev.ev_cascar_c_followup.choice_2_result: 799e6b009d5e
  ev.ev_cascar_c_followup.choice_3: 56c395d21fbe
  ev.ev_cascar_c_followup.choice_3_result: e4e5506bb578
  ev.ev_cascar_mentor_followup.title: a03cb5f83aa3
  ev.ev_cascar_mentor_followup.body: 335e7613c2b1
  ev.ev_cascar_mentor_followup.choice_1: 522c8a6f222f
  ev.ev_cascar_mentor_followup.choice_1_result: 90b5a1912d36
  ev.ev_cascar_mentor_followup.choice_2: a8bfb3184e56
  ev.ev_cascar_mentor_followup.choice_2_result: df0665a4953b
  ev.ev_cascar_mentor_followup.choice_3: 52194246914c
  ev.ev_cascar_mentor_followup.choice_3_result: bcb141a03f0a
---
...
可失合儿是丝路上最富的绿洲，帕米尔与喀喇昆仑的融水沿山谷而下，在沙漠之心浇出一片绿色乐园。
杏、石榴、桑、核桃与杏仁园沿灌渠绵延数里；葡萄沉甸甸压弯架，棚架须年年更换。其人信穆斯林，
却仍守先知时代以前的许多旧俗。可失合儿的葡萄晒成干；瓜为天下最甜最大。行旅既越山、
初尝可失合儿瓜者，一月之内言谈皆不及他事。
...
可失合儿的地毯织得极细，人可将其穿过一只指环。城中妇人数月织一毯，凭记忆描图案，
凭气味识每一种染料：茜根为红，蓝靛为蓝，石榴皮为黄，核桃壳为褐，又有山中秘矿所出之绿，
百年方褪。人言图案中藏有祈祷——图案合宜的毯子，可护主免恶眼、蛇咬与沙漠之灵。购可失合儿毯的商人行旅从不离之；
传入欧洲宫廷之毯，被待如王者之宝。
...
城墙外，石灰岩崖面有一洞，据说七位圣人在此沉睡。穆斯林言彼等自先知之前即已沉睡，
等待审判之日。基督徒言彼等即以弗所的七眠者，奇迹般迁至此。洞口并立一座masjid（清真寺）
与一座小教堂，共一面崖壁。两教朝圣者皆来，彼此不相扰。僧侣与毛拉轮流清扫洞中；蜡烛、
香与银币之供献均分。人言：夜宿洞中者，可闻沉睡者之呼吸。
...
可失合儿是一片地方，位于东北与正东之间，从前曾是一个王国，如今臣服于大汗。这里的人礼拜摩诃末。
市镇村落很多，但最大最美的是可失合儿本城。居民靠贸易与手艺为生；有许多美丽的园囿与葡萄园、
良田，并种许多棉花。从这片地方，许多商人外出四方行商。土著是吝啬可怜的一等人，饮食极为寒酸。
国中有许多景教徒，有自己的教堂。国人有自己的一种特别语言，这个地方延展约五日路程。
...
离开喀什噶尔之前，山口驿站的领路人问你从这里看出了什么。这个教诲不是法术，也不是交易；它只是教你留意道路转弯之后真正有用的细节。
...
最高一畦的果园看守人在融水入园之处、灌溉渠首与你相遇。他看护这片果园五十年，识得
每一棵树所结之果。他告诉你，这水在到可失合儿之前行过怎样的路：自帕米尔之雪而下，
沿山谷经驿道，每站换马，然后入渠，灌溉全城的绿色长带。然后他把你领到一株独植的
葡萄藤前，它靠着园墙生长，与众株隔开。他说，此藤之种，是其祖父在一场大雪之年越
同一山口携来。此藤他不肯卖。但他把这季结出的瓜献给你，连同种子翻山而来的故事。
他说，可失合儿的园子之所以常甜，正因为人人记得每一粒种子的来处。你要从这座果园
带走什么，带走几分灌溉它的那条路，全凭你自己决定。
...
看守人在水边切开甜瓜，把最大的一块递给你。那份甜一整天都在你口中，而那翻山越岭
的故事，从此记入你的行纪。
...
看守人自帕米尔之雪画下到可失合儿的道路，标出山口与每一座驿站。去巴达哈伤的路如今
清楚印在你的舆图上，你也知道沙漠如何饮水。
...
看守人把几粒种子包在布里，按入你的掌心。无论你在何处种下，可失合儿的人都会记得，
你曾为他们的园子说过话。
...
为毯市配齐每一种颜色的染匠，把你叫进集市后面的院子，一溜染锅排在那里。她问你在
毯子上看见了什么；你答了，她便点头，仿佛你过了某道考较。她拾起一张未完工地毯的
边饰，高声读出：她说，这图案是一段祈祷，折进羊毛里，好让一座宅院住在其中。她凭
气味识得每一种颜色——茜根、蓝靛、石榴皮、核桃壳——至于那绿色，她守住一个秘密。
染出绿色的矿物，产自南行两日之路外的丘陵，平原之上；可失合儿只有两户人家知道那座
矿坑。她愿意给你院里现成的染材、边饰的读法，以及通往绿矿的那条路。她说，一张毯子
唯有带着织者的心意同往，才能护其主；折进羊毛的祈祷，终究还是祈祷。要带走什么，
由你自己挑选。
...
染匠按自己的价把那张小毯卖给你，不还价，也无花招。图案纯正，羊毛软如水，边饰里藏
着她方才为你读出的那段祈祷。
...
染匠画出南行两日的道路，指向那绿矿所在的丘陵，只把她家所知的那座矿坑标出。去鸦儿看
的路如今上了你的舆图，你也知道那丘陵里藏着什么。
...
你在染匠的长凳边度过一日，学那图案如何把祈祷折进羊毛。这花费了时日，但从此没有
一张毯子在你眼中还与从前一样。
...
洞口，小教堂的僧侣与清真寺的毛拉一同迎你，两教如平日那般并肩立于石中。他们听说你
彻夜谛听。两人各自把七位眠者的名字给你——而两份名单并不相同。毛拉给你他书上写着的
名字；僧侣给你以弗所七眠者之名。两人都坚持：洞中所卧，正是同一七人。他们问你自哪条
路来到可失合儿；你答了，僧侣便告诉你自东而来的朝圣之路——七眠者的故事正是沿此路，
从一教传至另一教，还有于阗的绿洲，那里的集市上两则传说同被传述。洞中之供献均分，
他们说，真理也是如此。要带走两份名单、带走那条路，还是再守一夜的夜，他们全留给你。
...
僧侣写下一份名单，毛拉又写一份，两张纸都被按入你的手中。从此你以两个名字携带七眠者，
而此洞两说并纳。
...
僧侣画出七眠者故事自东而来的路，经过于阗的绿洲。你不会再盲目踏上它，也知道那路上的
朝圣者携带什么。
...
你在洞口又守了一夜，听僧侣与毛拉轮流挥帚。那呼吸不再出现，但两教的守洞人都记得你
留下来过。
...
山口驿站的领路人不让你只带走他的讲述。他从腕上解下一段绳子，隔一段打一个结，铺在
两人之间的石上。他说，每个结是一座驿站，自可失合儿至山口；不识字的人，也能凭它数清
路程。他年轻时在山间递送官驿，夜宿各站，暗中换马，这段绳是他一生唯一用过的舆图。
他把出城的道路如数家珍地一一说来：官驿攀往山口的道，商旅西去撒马尔罕的道，还有商队
自南方上来的道。他愿给你这段绳、这些路的名字，以及一日的耐心。他说，你自己挑最合用
的一样，因为一条路的好坏，全看你带什么走上它。
...
领路人把绳结套上你的手腕。可失合儿的各站从此随你同行，它们数出的那段路，不会在你
脚下走完。
...
领路人画出商旅自可失合儿西行的路，标出水井与饮水之处。去撒马尔罕的路如今清楚地印在
你心里，你也知道沿途何处有水可饮。
...
你在驿站度过一日，学各站如何把消息传上群山、园子又如何在下游得水。这花费了时日，
但可失合儿从此留下你的一分。
