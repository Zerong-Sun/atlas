...
export const ICHING_REFERENCE: MethodReferenceLibrary = {
  ...
  patterns: [
    ...
    pattern("tai-tong", "地天泰", "常用卦", "吉", "上下交通、顺遂。", "利合作、通达、推进。", "泰极则否。", "顺势但防骄。"),
    pattern("pi-ge", "天地否", "常用卦", "凶", "上下隔绝、阻塞。", "宜等待、换路径。", "否极泰来。", "不强行突破。"),
    pattern("ji-ji-fang", "水火既济", "常用卦", "平", "事成将满。", "利收尾、防初吉终乱。", "问进行中吉，问终局慎。", "成功后仍要守成。"),
    pattern("wei-ji-tu", "火水未济", "常用卦", "平", "事未竟成。", "仍在途中，需耐心。", "勿急断失败。", "持续投入但设检查点。"),
    pattern("ge-bian", "泽火革", "常用卦", "平", "变革更新。", "旧局将改，抓动变。", "革故鼎新有代价。", "备Plan B。"),
