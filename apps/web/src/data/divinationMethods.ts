...
export const DIVINATION_METHODS: DivinationMethod[] = [
  ...
  { id: "qimen", title: "奇门遁甲", subtitle: "局盘、九宫、八门、九星、神煞与时空取象。", tradition: "术数", route: "/methods/qimen", status: "preview", tags: ["九宫", "八门"] },
  { id: "ziwei", title: "紫微斗数", subtitle: "命盘十二宫、主星辅星与大限流年。", tradition: "术数", route: "/methods/ziwei", status: "preview", tags: ["十二宫", "大限"] },
  { id: "liuyao", title: "纳甲六爻", subtitle: "铜钱起卦、世应六亲、用神旺衰。", tradition: "易", route: "/methods/liuyao", status: "preview", tags: ["用神", "世应"] },
  { id: "meihua", title: "梅花易数", subtitle: "时空取数、体用生克与外应判断。", tradition: "易", route: "/methods/meihua", status: "preview", tags: ["体用", "外应"] },
  { id: "western", title: "西洋占星", subtitle: "本命盘、行运、相位与宫位解释。", tradition: "星占", route: "/methods/western", status: "preview", tags: ["本命盘", "行运"] },
  ...
  { id: "lot", title: "抽签签诗", subtitle: "签文、解曰、典故与事项分类。", tradition: "签占", route: "/methods/lot", status: "preview", tags: ["签文", "典故"] },
  ...
  { id: "fengshui", title: "风水罗盘", subtitle: "方位、坐向、九宫飞星与空间建议。", tradition: "堪舆", route: "/methods/fengshui", status: "preview", tags: ["方位", "飞星"] },
  { id: "astrodice", title: "占星骰子", subtitle: "行星、星座、宫位三骰组合解释。", tradition: "星占", route: "/methods/astrodice", status: "preview", tags: ["三骰", "组合"] },
  { id: "lenormand", title: "雷诺曼牌", subtitle: "日签、九宫格与牌间语法。", tradition: "卡牌", route: "/methods/lenormand", status: "preview", tags: ["九宫格", "牌语法"] },
